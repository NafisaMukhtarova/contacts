...
try {
    $result->execute($data);
    $log->debug('Обновление записи в таблице contacts ', ['contact_id' => $data[':id'], 'contact_name' => $data[':contact_name']]);
} catch(PDOException $e) {
        $log->error('Ошибка обновления записи в таблице contacts', ['message' => $e->getMessage()]);
        echo $e->getMessage();
}
